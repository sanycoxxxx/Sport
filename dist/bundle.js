...
function modal(modal_Trigger, modal_window) {
  ...
  const modalTimerId = setTimeout(openModal, 5000000000); // function showModalByScroll() {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_services_services_js__WEBPACK_IMPORTED_MODULE_0__.postsData)("http://localhost:3000/requests", json).then(data => {
        console.log(data);
...
;
/* harmony default export */ __webpack_exports__["default"] = (timerSet);
...
/* harmony export */   "postsData": function() { return /* binding */ postsData; }
/* harmony export */ });
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_slider__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_tabs__WEBPACK_IMPORTED_MODULE_6__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items');
  _index__WEBPACK_IMPORTED_MODULE_0__["default"].say();
});
}();
/******/ })()
;
